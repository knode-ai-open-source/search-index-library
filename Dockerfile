...
# a-tokenizer-library
RUN git clone \
      https://${GITHUB_TOKEN}@github.com/knode-ai-open-source/a-tokenizer-library.git \
      /workspace/a-tokenizer-library && \
      cd /workspace/a-tokenizer-library && ./build_install.sh && \
      rm -rf /workspace/a-tokenizer-library
